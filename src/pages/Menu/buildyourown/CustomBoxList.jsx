        ...
        <div className="custom-box-wrapper">
          ...
          <div className="custom-box-header">
            <button
              ...
              className="custom-box-clear-btn"
            >
              Clear Box
            </button>
          </div>
          ...
          {!noNigiris && (
            <div className="custom-box-section">
              <h4 className="custom-box-section-title">Nigiris</h4>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="custom-box-item-details">
                      ...
                      <p className="custom-box-item-price">
                      ...
                      <div className="custom-box-item-actions">
                        ...
                        <div className="custom-box-quantity-control">
                          <button
                            ...
                            onClick={() =>
                              quantity > 1
                                ...
                                : deleteNigiriFromCustomBox({ nigiriId })
                            }
                          ...
                          <span className="custom-box-quantity-display">
                            {quantity}
                          </span>
      ...
      {!noSauces && (
        <div>
          ...
          {customBox.sauces.map((sauce) => {
            ...
            return (
              <div
                key={sauce.user_custom_box_sauce_id}
                className="custom-box-item"
              >
                <img
                  src={sauce.image_url}
                ...
                <div className="custom-box-item-details">
                  ...
                  <div className="custom-box-item-actions">
                      ...
                      <button
                        ...
                        onClick={() =>
                          quantity > 1
                            ...
                            : deleteSauceFromCustomBox({ sauceId })
                        }
                        className="custom-box-quantity-btn"
                      >
                        {quantity > 1 ? (
                    ...
                    <button
                      type="button"
                      onClick={() => deleteSauceFromCustomBox({ sauceId })}
                      className="custom-box-delete-btn"
                    >
                      Delete
                    </button>
      ...
      {!noExtras && (
        <div>
          ...
          {customBox.extras.map((extra) => {
            ...
            return (
              <div
                key={extra.user_custom_box_extra_id}
                className="custom-box-item"
              >
                <img
                  src={extra.image_url}
                ...
                <div className="custom-box-item-details">
                  ...
                  <div className="custom-box-item-actions">
                    ...
                    <button
                      type="button"
                      onClick={() => deleteExtraFromCustomBox({ extraId })}
                      className="custom-box-delete-btn"
                    >
                      Delete
                    </button>
